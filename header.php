...
$formats = ["Standard", "Pioneer", "Modern", "Legacy", "Vintage", "Commander", "Pauper", "Oathbreaker"];
$color_comb = "";
$maxResultPerPage = 30;
...
<head>
	...
	<meta name="description" content="MTG Packages: a community-based effort to organize and rank the best cards of each archetype.">
...
<header class="top">
	<h1>MTG Packages</h1>
	<form action="filter.php" id="colors" method="get">
